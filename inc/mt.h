...
/*   Updated: 2025/06/02 15:23:32 by danpalac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void            ft_mtremove(t_mt **head, t_mt *target, bool free_node);
...
// 
t_backup		*ft_backup_static(size_t slot_count, bool reset, bool clear);
...
void			ft_backup_remove_track(t_backup **backup, t_track *node, bool free_target, bool free_node);
...
t_mt             *ft_mtget(t_mt *node, const char *key);
...
int				ft_mtset_key(t_mt *mt, const char *key);
int				ft_mtset_id(t_mt *mt, int id);
int				ft_mtset_data(t_mt *mt, void *data, t_free_func free_func);
int				ft_mtset_addon(t_mt *mt, void *addon, t_free_func free_func);
